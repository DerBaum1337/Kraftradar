...
test('affiliate component contains partner-specific copy and safe link attributes', () => {
...
test('existing HSN articles and the Amazon shaker use the automatic box', () => {
	...
	assert.match(shaker, /url: "https:\/\/amzn\.to\/4fALWsN"/);
	assert.doesNotMatch(shaker, /\*\*Produktlink:\*\* \[720°DGREE uberShaker/);
});

test('privacy page explains HSN and Amazon affiliate links', () => {
